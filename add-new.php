...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `crud`(`id`, `Client_name`, `Client_code`, `email`, `datepicker`,`Contact_no`,`MOD`,`Deposit_Amount`,`Amount_in_Words`,`Select_bank`,`Other_Known_Details`,`Type_name`,`Informed_Delivered_By`,`Proof`,`remarks`,`Reference_no`) VALUES
                            (NULL,'$Client_name','$Client_code','$email','$datepicker','$Contact_no','$MOD','$Deposit_Amount','$Amount_in_Words','$Select_bank','$Other_Known_Details','$Type_name','$Informed_Delivered_By','$Proof','$remarks','$Reference_no')";
...
<!-- changing -->
            ...
            <div class="col form-col-checkboxs">
              ...
              <br/>
                ...
                <input  type="radio" class="form-check-input" name="Cheque" id="Bank_Transfer" VALUES  onclick="text(0)" />
               <label for="Bank_Transfer" class="form-input-label"><b>Bank Transfer</b></label>
               &nbsp;
               <input type="radio" class="form-check-input" name="Cheque" id="Cheque" value="Cheque" onclick="text(0)"/>
               <label for="Cheque" class="form-input-label"><b>Cheque</b></label>
               &nbsp;
               <input type="radio" class="form-check-input" name="Cheque" id="Cash" value="Cash" onclick="text(1)"/>
            ...
            <div class="col form-col">
             ...
             &nbsp;
               ...
               <input class="col" type="radio" class="form-control" name="MOD" id="Bank_Transfer" VALUES  onclick="text(0)" />
               <label for="Bank_Transfer" class="form-input-label"><b>Bank Transfer</b></label>
               &nbsp;
               <input type="radio" class="form-check-input" name="Cheque" id="Cheque" value="Cheque" onclick="text(0)"/>
               <label for="Cheque" class="form-input-label"><b>Cheque</b></label>
               &nbsp;
               <input type="radio" class="form-check-input" name="Cash" id="Cash" value="Cash" onclick="text(1)"/>
               <label for="Cash" class="form-input-label"><b>Cash </b></label>
               </div>
            <div class="col">
            <label for="datepicker" class="col">Date Of Deposit:
               &nbsp;&nbsp;&nbsp;&nbsp;</label>
            <input type="date" id="datepicker" class="form-control" name="datepicker" required>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col form-col" id="mycode">
                  <label class=""></label>
                  <input type="number" class="form-control" name=" $Reference_no" placeholder="Reference Number" Required >
               </div>
               <div class="col form-col">
            ...
            <div class="row mb-3" id="mycode">
              ...
              <div class="col form-col">
                  ...
                  <input type="file" class="form-control" name="Proof" placeholder="Upload Proof" required >
               </div>
            </div>
